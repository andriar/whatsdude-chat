<template>
  <div class="p-4 mx-4 mb-4 border border-gray-200 rounded-lg bg-white shadow-sm">
    <!-- Input Area -->
    <div class="flex flex-col gap-y-2">
      <!-- Message Input -->
      <div>
        <UTextarea v-model="message" autoresize variant="none" placeholder="Send a message..." class="w-full" :ui="{
